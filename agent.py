...
You will answer job interviewer's PROMPT. KNOWLEDGE is provided by Kong Ren Hwai. OPENING DESCRIPTION is provided by hiring manager.
...
PROMPT: {prompt}
KNOWLEDGE: {passage}
OPENING DESCRIPTION: {job_summary}
