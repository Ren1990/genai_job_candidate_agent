...
Starting from below are JOB DESCRIPTION provided by hiring manager. You should not used below as your KNOWLEDGE. If JOB DESCRIPTION is blank. You can ignore JOB DESCRIPTION.
JOB DESCRIPTION: {job_summary}
